<?php
if(isset($_GET['sewage']))
{
echo ' <script language="javascript" type="text/javascript">
parent.document.location="sewage.php";
</script>';
}
...
{
	echo ' <script language="javascript" type="text/javascript">
parent.document.location="employee.php";
</script>';
...
<div class="row">
  ...
  <div class="column">
    <div class="card">
      ...
      <img src="sewage.png" alt="Nature" width="200px" height="200px">
      <br><br><button type="submit" name="sewage" class="registerbtn">Drainage</button>
    <br><br> </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <h3>Drainage Employee</h3>
	 <img src="employee.png" alt="Nature" width="200px" height="200px">

      <br><br><button type="submit" name="employee" class="registerbtn">Drainage employee</button>
