...
<br><br>
<center><h3 style="font-weight: bold; color: green">Drainage Employee Health monitoring</h3></center>
<br><br>
...
<div class="row">
  ...
  <div class="column">
    <div class="card">
      <h3>Drainage Employee Heartbeat Value</h3>
      <img src="heart.png" alt="Nature" width="200px" height="200px"><br><br>
      Heartbeat : <?php echo $hb." bpm" ?><br><br>
      <br> </div>
  </div>
